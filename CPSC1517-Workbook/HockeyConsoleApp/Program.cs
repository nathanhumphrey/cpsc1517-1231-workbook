...
HockeyPlayer player2 = new HockeyPlayer("Bobby", "Orr", "Kithchener, ON", new DateOnly(1965, 9, 23),
...
Console.WriteLine($"Date in future? {Utils.IsInTheFuture(new DateTime(2023, 9,12))}");
